        ...
        <?php if(isset($INFO['userinfo'])) { ?>
		  <span class="userlink" style="display: <?php echo (strpos($ID,"user:") !== false ? 'block' : 'none'); ?>;">
		    <?php
		    	...
		    	echo '<a href="http://fachschaft.informatik.uni-wuerzburg.de/lam/templates/account/edit.php?type=user&DN=\'uid%3D'.$match.'%2Cou%3DPeople%2Cdc%3Dfmi-wuerzburg%2Cdc%3Dde\'">'.
				            	 "Profil von ".$match."</a>";
		    ?>
		  </span>
		<?php } ?>
